...
Craft.EntryTemplates.TemplateIndex = Craft.BaseElementIndex.extend({
	...
	afterInit: function () {
		this.entryTypes = Craft.sendActionRequest("POST", "entrytemplates/templates/types").catch((t) =>
			console.warn("Unable to get entry types"),
		);
	},
...
Craft.registerElementIndexClass(
	"towardstudio\\entrytemplates\\elements\\EntryTemplate",
